...
* research chains: **8**  *  named gaps: **10**  *  endpoint count: **8**  *  orphan debt files: **419**  *  taxonomy-labelled debt files: **12**  *  rule-labelled debt files: **410**  *  connectable debt files: **412**  *  build components: **28**  *  branch heads: **73**
...
graph TD
  ...
  chain_hcgap_l4_multifront_active["HCGapL4 multi-front attack waves (R420 -- R681)\nexploratory"]:::active
  ...
  gap_G_hcgap_l4_multifront{{"HCGapL4 multi-front Layer-4 attack waves (R420 -- R681)\nactive-open"}}:::gapOpen
...
| `G-hcgap-l4-multifront` | active-open | HCGapL4 multi-front Layer-4 attack waves (R420 -- R681) | on-disk-unloaded: 3, registered: 121 |
...
* rule-labelled debt files: **410**
* unconnected debt files: **7**
* unlabelled off-chain debt files: **407**
...
### `hcgap-l4-multifront-active` -- HCGapL4 multi-front attack waves (R420 -- R681)
...
### `G-hcgap-l4-multifront` -- HCGapL4 multi-front Layer-4 attack waves (R420 -- R681)
