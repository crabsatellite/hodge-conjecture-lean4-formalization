...
graph TD
  ...
  chain_hcgap_l4_multifront_active["HCGapL4 multi-front attack waves (R420 -- R779)\nexploratory"]:::active
  ...
  gap_G_hcgap_l4_multifront{{"HCGapL4 multi-front Layer-4 attack waves (R420 -- R779)\nactive-open"}}:::gapOpen
...
| `hcgap-l4-multifront-active` | active | exploratory | `G-hcgap-l4-multifront` | registered: 202 |
...
| `G-hcgap-l4-multifront` | active-open | HCGapL4 multi-front Layer-4 attack waves (R420 -- R779) | registered: 223 |
...
### `hcgap-l4-multifront-active` -- HCGapL4 multi-front attack waves (R420 -- R779)
...
### `G-hcgap-l4-multifront` -- HCGapL4 multi-front Layer-4 attack waves (R420 -- R779)
...
- `HodgeReduction/HCGapL4/FrontC107_H8ResidualLineEqualityFiniteUpperBound.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC108_H8ResidualBoundaryDataLineEquality.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC109_H8ResidualBoundaryDataEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC110_H8ResidualBoundaryDataTargetLineEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC111_H8ResidualBoundaryDataCompactDualEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC112_H8ResidualExactImageContainmentBoundaryEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC113_H8ResidualExactImageCompactDualContainmentEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC114_H8ResidualExactImageCartanContainmentEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC115_H8ResidualExactImageCartanLineContainmentEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC116_H8ResidualExactImageCartanLineThreeTargetEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC117_H8ResidualSourceCompactDualCartanLineThreeTargetEquivalence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC118_H8ResidualCartanLineExactnessFromSourceCompactDual.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC119_H8ResidualCartanBoundaryEquality.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC120_H8ResidualBoundaryDataCartanContract.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC121_H8ResidualBoundaryDataSourceInvariantRoute.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC122_H8ResidualBoundaryDataSourceH8Obstruction.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC123_H8ResidualGeneratorMultiplicityRoute.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC124_H8ResidualSourceBoundaryGeneratorMultiplicityRoute.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC125_H8ResidualSourceBoundaryCartanLineRoute.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC126_H8ResidualExplicitFiniteMultiplicityRoute.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC127_H8ResidualLineContainmentExplicitFiniteRoute.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC128_H8ResidualSourceH8LineContainmentRoute.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC129_H8ResidualSourceH8GeneratorIndependence.lean` -- registered
- `HodgeReduction/HCGapL4/FrontC130_H8ResidualBoundaryDataSourceSurjectivityRoute.lean` -- registered
