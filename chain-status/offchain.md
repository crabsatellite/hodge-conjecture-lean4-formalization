...
* registered: **257** (configured research route/gap files, off endpoint closure)
...
## Registered research routes/gaps (257)
...
| `HodgeReduction/HCGapL4/FrontC128_H8ResidualSourceH8LineContainmentRoute.lean` | 45 | 0 |
| `HodgeReduction/HCGapL4/FrontC129_H8ResidualSourceH8GeneratorIndependence.lean` | 59 | 0 |
| `HodgeReduction/HCGapL4/FrontC12_V56InfrastructureProfileBridge.lean` | 33 | 0 |
| `HodgeReduction/HCGapL4/FrontC130_H8ResidualBoundaryDataSourceSurjectivityRoute.lean` | 43 | 0 |
| `HodgeReduction/HCGapL4/FrontC131_H8ResidualBoundaryDataSourceSurjectivityObstruction.lean` | 27 | 0 |
| `HodgeReduction/HCGapL4/FrontC132_H8ResidualBoundaryDataSourceSurjectivityTargetLineEquivalence.lean` | 35 | 0 |
| `HodgeReduction/HCGapL4/FrontC133_H8ResidualBoundarySourceSurjectivityFiniteUpperBoundEquivalence.lean` | 30 | 0 |
| `HodgeReduction/HCGapL4/FrontC134_H8ResidualFiniteUpperBoundRankOneTarget.lean` | 43 | 0 |
| `HodgeReduction/HCGapL4/FrontC135_H8ResidualFiniteRankOneTrivialMultiplicity.lean` | 47 | 0 |
| `HodgeReduction/HCGapL4/FrontC136_H8ResidualFiniteTrivialMultiplicityExplicitRoute.lean` | 34 | 0 |
| `HodgeReduction/HCGapL4/FrontC137_H8ResidualCartanImageFiniteMultiplicity.lean` | 34 | 0 |
| `HodgeReduction/HCGapL4/FrontC138_H8ResidualCartanImageBoundarySourceH8Equivalence.lean` | 34 | 0 |
| `HodgeReduction/HCGapL4/FrontC139_H8ResidualBoundarySourceCompactDualEquivalence.lean` | 33 | 0 |
| `HodgeReduction/HCGapL4/FrontC13_MatsushimaV56BoundaryBridge.lean` | 26 | 0 |
| `HodgeReduction/HCGapL4/FrontC140_H8ResidualBoundaryCompactDualCarrierSplit.lean` | 45 | 0 |
| `HodgeReduction/HCGapL4/FrontC141_H8ResidualBoundaryCarrierIndependence.lean` | 54 | 0 |
| `HodgeReduction/HCGapL4/FrontC142_H8ResidualCompactDualFiniteRankCarrierRoute.lean` | 46 | 0 |
| `HodgeReduction/HCGapL4/FrontC143_H8ResidualCompactDualRankBoundSharpness.lean` | 33 | 0 |
| `HodgeReduction/HCGapL4/FrontC144_H8ResidualSourceInvariantFiniteRankCarrierRoute.lean` | 47 | 0 |
| `HodgeReduction/HCGapL4/FrontC145_H8ResidualSourceInvariantRankBoundSharpness.lean` | 33 | 0 |
| `HodgeReduction/HCGapL4/FrontC146_H8ResidualSourceFiniteRankToCarrierSplit.lean` | 35 | 0 |
| `HodgeReduction/HCGapL4/FrontC147_H8ResidualSourceFiniteDimensionalityGuard.lean` | 31 | 0 |
| `HodgeReduction/HCGapL4/FrontC148_H8ResidualSourceGeneratorContainmentRoute.lean` | 44 | 0 |
| `HodgeReduction/HCGapL4/FrontC149_H8ResidualSourceContainmentFiniteRankConsumer.lean` | 39 | 0 |
| `HodgeReduction/HCGapL4/FrontC14_CartanCompactDualSourceBridge.lean` | 18 | 0 |
| `HodgeReduction/HCGapL4/FrontC150_H8ResidualSourceTwoSidedContainmentRoute.lean` | 49 | 0 |
| `HodgeReduction/HCGapL4/FrontC151_H8ResidualSourceH8EqualityRoute.lean` | 42 | 0 |
| `HodgeReduction/HCGapL4/FrontC152_H8ResidualSourceEqualityCompactDualRoute.lean` | 32 | 0 |
| `HodgeReduction/HCGapL4/FrontC153_H8ResidualCompactDualFiniteRankAttackRoute.lean` | 34 | 0 |
| `HodgeReduction/HCGapL4/FrontC154_H8ResidualPrimitiveBoundaryFiniteRankRoute.lean` | 57 | 0 |
| `HodgeReduction/HCGapL4/FrontC155_H8ResidualCompactDualGeneratorContainmentRoute.lean` | 47 | 0 |
| `HodgeReduction/HCGapL4/FrontC156_H8ResidualCompactDualTwoContainmentRoute.lean` | 44 | 0 |
| `HodgeReduction/HCGapL4/FrontC157_H8ResidualBoundaryCompactDualPrimitiveCollapse.lean` | 32 | 0 |
...
| `HodgeReduction/HCGapL4/FrontC161_H8ResidualPaperCarrierCartanContainmentIndependence.lean` | 64 | 0 |
| `HodgeReduction/HCGapL4/FrontC162_H8ResidualCompactDualGeneratorGeometryRoute.lean` | 55 | 0 |
| `HodgeReduction/HCGapL4/FrontC163_H8ResidualCurrentSourceInvariantRoute.lean` | 33 | 0 |
| `HodgeReduction/HCGapL4/FrontC164_H8ResidualCurrentGeneratorLineRoute.lean` | 46 | 0 |
| `HodgeReduction/HCGapL4/FrontC165_H8ResidualCurrentCompactDualGeneratorLineRoute.lean` | 45 | 0 |
| `HodgeReduction/HCGapL4/FrontC166_H8ResidualCurrentCompactDualTwoContainmentRoute.lean` | 47 | 0 |
| `HodgeReduction/HCGapL4/FrontC167_H8ResidualCurrentTwoContainmentIndependence.lean` | 34 | 0 |
| `HodgeReduction/HCGapL4/FrontC168_H8ResidualNoExtraTargetLineEquivalence.lean` | 46 | 0 |
| `HodgeReduction/HCGapL4/FrontC169_H8ResidualTargetLineFiniteMultiplicityEquivalence.lean` | 48 | 0 |
| `HodgeReduction/HCGapL4/FrontC16_MatsushimaTargetContainmentFromSource.lean` | 6 | 0 |
| `HodgeReduction/HCGapL4/FrontC170_H8ResidualFiniteMultiplicityIndependence.lean` | 33 | 0 |
| `HodgeReduction/HCGapL4/FrontC171_H8ResidualFiniteMultiplicityQuotientBridge.lean` | 51 | 0 |
| `HodgeReduction/HCGapL4/FrontC172_H8ResidualSourceH8QuotientMinimalRoute.lean` | 48 | 0 |
| `HodgeReduction/HCGapL4/FrontC173_H8ResidualSourceH8QuotientCollapse.lean` | 36 | 0 |
| `HodgeReduction/HCGapL4/FrontC174_H8ResidualBoundaryTargetLineCurrentRoute.lean` | 37 | 0 |
| `HodgeReduction/HCGapL4/FrontC175_H8ResidualTargetLinePrimitiveSplit.lean` | 48 | 0 |
| `HodgeReduction/HCGapL4/FrontC176_H8ResidualTargetGeneratorBoundaryTransport.lean` | 50 | 0 |
| `HodgeReduction/HCGapL4/FrontC177_H8ResidualTargetInvariantFiniteMultiplicityCurrentRoute.lean` | 38 | 0 |
| `HodgeReduction/HCGapL4/FrontC178_H8ResidualFiniteMultiplicityScalarPreimageCurrentRoute.lean` | 50 | 0 |
| `HodgeReduction/HCGapL4/FrontC179_H8ResidualCartanImageExactCurrentRoute.lean` | 46 | 0 |
| `HodgeReduction/HCGapL4/FrontC17_MatsushimaTargetRankFromSource.lean` | 6 | 0 |
| `HodgeReduction/HCGapL4/FrontC180_H8ResidualCartanImageSurjectivityCurrentRoute.lean` | 46 | 0 |
| `HodgeReduction/HCGapL4/FrontC181_H8ResidualLatestRouteBoundaryCartanCollapse.lean` | 36 | 0 |
| `HodgeReduction/HCGapL4/FrontC182_H8ResidualLatestRouteFiniteRankAttack.lean` | 38 | 0 |
| `HodgeReduction/HCGapL4/FrontC183_H8ResidualLatestRouteRankOneGeneratorAttack.lean` | 47 | 0 |
| `HodgeReduction/HCGapL4/FrontC184_H8ResidualRankOneGeneratorCompactDualH8Collapse.lean` | 37 | 0 |
| `HodgeReduction/HCGapL4/FrontC185_H8ResidualRankOneGeneratorPaperCarrierIndependence.lean` | 30 | 0 |
| `HodgeReduction/HCGapL4/FrontC186_H8ResidualBoundaryCompactDualTargetRankRoute.lean` | 45 | 0 |
| `HodgeReduction/HCGapL4/FrontC187_H8ResidualTargetRankNonzeroSplit.lean` | 54 | 0 |
| `HodgeReduction/HCGapL4/FrontC188_H8ResidualTargetNonzeroFromCompactDual.lean` | 58 | 0 |
| `HodgeReduction/HCGapL4/FrontC189_H8ResidualFiniteUpperToTargetLineRoute.lean` | 50 | 0 |
| `HodgeReduction/HCGapL4/FrontC18_MatsushimaSourceCompactDualRankBridge.lean` | 6 | 0 |
| `HodgeReduction/HCGapL4/FrontC190_H8ResidualTargetLineCartanImageRoute.lean` | 46 | 0 |
| `HodgeReduction/HCGapL4/FrontC191_H8ResidualCartanImageBoundaryConsumer.lean` | 37 | 0 |
| `HodgeReduction/HCGapL4/FrontC192_H8ResidualCurrentCartanImageGuardrail.lean` | 30 | 0 |
| `HodgeReduction/HCGapL4/FrontC193_H8ResidualBoundaryCompactDualCartanImagePointwise.lean` | 33 | 0 |
| `HodgeReduction/HCGapL4/FrontC194_H8ResidualCompactDualSourceInvariantBridge.lean` | 34 | 0 |
| `HodgeReduction/HCGapL4/FrontC195_H8ResidualSourceInvariantExactRankGenerator.lean` | 34 | 0 |
| `HodgeReduction/HCGapL4/FrontC196_H8ResidualExactSourceRankGeneratorIndependence.lean` | 67 | 0 |
| `HodgeReduction/HCGapL4/FrontC197_H8ResidualSourceRankNoExtraEquivalence.lean` | 34 | 0 |
| `HodgeReduction/HCGapL4/FrontC198_H8ResidualSourceContainmentIndependence.lean` | 103 | 0 |
| `HodgeReduction/HCGapL4/FrontC199_H8ResidualTargetLineSourceContainmentBridge.lean` | 36 | 0 |
| `HodgeReduction/HCGapL4/FrontC19_MatsushimaSourceCompactDualObstruction.lean` | 26 | 0 |
| `HodgeReduction/HCGapL4/FrontC200_H8ResidualTargetLineNonzeroGenerator.lean` | 37 | 0 |
| `HodgeReduction/HCGapL4/FrontC201_H8ResidualTargetLineScalarCertificate.lean` | 59 | 0 |
| `HodgeReduction/HCGapL4/FrontC202_H8ResidualTargetNonzeroCertificate.lean` | 41 | 0 |
| `HodgeReduction/HCGapL4/FrontC203_H8ResidualBoundaryDataFromScalarCertificate.lean` | 41 | 0 |
| `HodgeReduction/HCGapL4/FrontC204_H8ResidualThreeFieldScalarRoute.lean` | 43 | 0 |
| `HodgeReduction/HCGapL4/FrontC205_H8ResidualGeneratorScalarRoute.lean` | 40 | 0 |
| `HodgeReduction/HCGapL4/FrontC206_H8ResidualCartanScalarRoute.lean` | 40 | 0 |
| `HodgeReduction/HCGapL4/FrontC207_H8ResidualCartanScalarCarrierClosure.lean` | 39 | 0 |
| `HodgeReduction/HCGapL4/FrontC208_H8ResidualExactImageScalarIndependence.lean` | 28 | 0 |
| `HodgeReduction/HCGapL4/FrontC209_H8ResidualCompactDualGeneratorScalarCarrierClosure.lean` | 38 | 0 |
| `HodgeReduction/HCGapL4/FrontC20_MatsushimaCompactDualExactImageCriterion.lean` | 6 | 0 |
| `HodgeReduction/HCGapL4/FrontC210_H8ResidualCompactDualGeneratorTargetLineEquality.lean` | 40 | 0 |
| `HodgeReduction/HCGapL4/FrontC211_H8ResidualCompactDualTargetLineUnifiedSurfaces.lean` | 54 | 0 |
| `HodgeReduction/HCGapL4/FrontC212_H8ResidualExactImageFromTargetLine.lean` | 33 | 0 |
| `HodgeReduction/HCGapL4/FrontC213_H8ResidualDesignationCoherenceCollapse.lean` | 61 | 0 |
