...
| `HodgeReduction.canonicalMTPackageAt` | `HodgeReduction/OpenHypotheses.lean` | OPEN (whitelisted) |
| `HodgeReduction.canonicalTargetAlgClassesData` | `HodgeReduction/OpenHypotheses.lean` | OPEN (whitelisted) |
| `HodgeReduction.canonicalTargetCohomologyData` | `HodgeReduction/OpenHypotheses.lean` | OPEN (whitelisted) |
