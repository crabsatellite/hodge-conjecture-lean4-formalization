...
- FrontC: construct the concrete EVII Matsushima/cuspidal instances.  After R555, the source half of R554 can be supplied by proving `surjectivity_source = MatsushimaData.source_invariants`; the target half remains `surjectivity_target = MatsushimaData.target_invariants`.  Then feed R553/R554/R555 together.
...
| `chain:hcgap-l4-multifront-active` | active | exploratory | `chain:main-hc-axiom-relative` | `gap:G-hcgap-l4-multifront` | on-disk-unloaded: 3, registered: 14 |
...
|-------------|-------|------:|-----------------|---------|--------|
| `chain:main-hc-axiom-relative` | active/exploring | 387 | core-support | on-disk-unloaded: 157, orphan: 230 | 2026-05-29 15:26 |
| `chain:hcgap-l4-multifront-active` | active/exploring | 308 | core-support | on-disk-unloaded: 96, orphan: 212 | 2026-05-29 15:26 |
| `gap:G-hcgap-l4-multifront` | active/exploring | 308 | core-support | on-disk-unloaded: 96, orphan: 212 | 2026-05-29 15:26 |
| `gap:G-main-hc` | active/exploring | 288 | core-support | on-disk-unloaded: 76, orphan: 212 | 2026-05-29 15:26 |
| `gap:G-l1-e7-shimura-tor` | active/exploring | 280 | core-support | on-disk-unloaded: 69, orphan: 211 | 2026-05-29 15:26 |
| `gap:G-l2-cohomology-construction` | active/exploring | 256 | core-support | on-disk-unloaded: 107, orphan: 149 | 2026-05-29 15:26 |
| `gap:G-l4-mt-correspondence` | active/exploring | 142 | core-support | on-disk-unloaded: 41, orphan: 101 | 2026-05-29 15:26 |
| `gap:G-l4-cm-abelian-hc` | active/exploring | 115 | core-support | on-disk-unloaded: 44, orphan: 71 | 2026-05-29 15:26 |
| `gap:G-l3-v56-mt-identification` | active/exploring | 96 | core-support | on-disk-unloaded: 67, orphan: 29 | 2026-05-29 15:26 |
| `chain:unconditional-classical` | active/exploring | 36 | core-support | on-disk-unloaded: 30, orphan: 6 | 2026-05-29 15:26 |
| `chain:hcgap-l2-trivial-instances` | closed/support | 256 | core-support | on-disk-unloaded: 107, orphan: 149 | 2026-05-29 15:26 |
| `chain:concrete-evii-toy` | closed/support | 155 | core-support | on-disk-unloaded: 80, orphan: 75 | 2026-05-29 15:26 |
| `gap:G-classical-mathlib-port` | classified | 28 | core-support | on-disk-unloaded: 23, orphan: 5 | 2026-05-29 15:26 |
