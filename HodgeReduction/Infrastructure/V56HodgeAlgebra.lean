...
theorem dim_V30 : Module.finrank ? Hodge_3_0 = 1 := finrank_Hodge_3_0

/-- V^{2,1} has dimension 27. -/
theorem dim_V21 : Module.finrank ? Hodge_2_1 = 27 := finrank_Hodge_2_1

/-- V^{1,2} has dimension 27. -/
theorem dim_V12 : Module.finrank ? Hodge_1_2 = 27 := finrank_Hodge_1_2

/-- V^{0,3} has dimension 1. -/
theorem dim_V03 : Module.finrank ? Hodge_0_3 = 1 := finrank_Hodge_0_3

/-- V_56 has dimension 56. -/
theorem dim_V56 : Module.finrank ? V56 = 56 := finrank
...
theorem hodge_dim_identity :
    Module.finrank ? Hodge_3_0 + Module.finrank ? Hodge_2_1
    + Module.finrank ? Hodge_1_2 + Module.finrank ? Hodge_0_3
    = Module.finrank ? V56 := finrank_Hodge_pieces_sum_eq_V56

/-- Numerical form: 1 + 27 + 27 + 1 = 56. -/
theorem hodge_dim_numerical : (1 : ?) + 27 + 27 + 1 = 56 := by omega
...
theorem hodge_symm_dim_30_03 :
    Module.finrank ? Hodge_3_0 = Module.finrank ? Hodge_0_3 := by
...
theorem dim_decomposition :
    Module.finrank ? V56 =
    Module.finrank ? Hodge_3_0 + 2 * Module.finrank ? J3O
    + Module.finrank ? Hodge_0_3 := by
  rw [finrank, finrank_Hodge_3_0, J3O.finrank, finrank_Hodge_0_3]
  omega

/-- Numerical: 1 + 2 * 27 + 1 = 56. -/
theorem dim_decomposition_numerical : (1 : ?) + 2 * 27 + 1 = 56 := by omega

/-! ## Even-dimensional property -/

/-- The total dimension 56 is even. -/
theorem dim_even : Module.finrank ? V56 % 2 = 0 := by omega
...
theorem j3o_pieces_dim :
    Module.finrank ? Hodge_2_1 + Module.finrank ? Hodge_1_2 = 54 := by
  rw [finrank_Hodge_2_1, finrank_Hodge_1_2]

/-- 2 + 54 = 56. -/
theorem total_dim_split :
    (Module.finrank ? Hodge_3_0 + Module.finrank ? Hodge_0_3)
    + (Module.finrank ? Hodge_2_1 + Module.finrank ? Hodge_1_2)
    = Module.finrank ? V56 := by
...
theorem codim1_dim_zero : (0 : ?) = 0 := rfl
