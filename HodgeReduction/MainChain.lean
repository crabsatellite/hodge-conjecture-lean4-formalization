...
def config : ChainAudit.ProjectConfig := {
  ...
  researchGaps := [
    ...
    },
    {
      ...
      title := "HCGapL4 multi-front Layer-4 attack waves (R420 -- R754)"
      status := "active-open"
      summary :=
  ...
  researchChains := [
    ...
    },
    {
      ...
      title := "HCGapL4 multi-front attack waves (R420 -- R754)"
      kind := "active"
      status := "exploratory"
      summary :=
      ...
      attackPlan := [
        ...
        "R754 next attack: prove `compactDual = H8`, prove `surjectivity_source = compactDual`, and prove `trivialModulePart <= span {j_q(h^4)}`; the finite-dimensional witness and upper bound rebuild from the target line under `compactDual = H8`.",
