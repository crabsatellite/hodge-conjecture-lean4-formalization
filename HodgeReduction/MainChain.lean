  ...
  researchChains := [
    ...
    },
    {
      ...
      attackPlan := [
        ...
        "R767 next attack: construct the scalar-preimage certificate from EVII Matsushima/Borel--Wallach multiplicity or quotient-vanishing geometry, prove nonzero `trivialModulePart` or nonzero finrank from automorphic geometry, and keep the genuine Matsushima boundary theorem as the separate R758 consumer target.",
