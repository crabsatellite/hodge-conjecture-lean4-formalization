...
def config : ChainAudit.ProjectConfig := {
  ...
  researchChains := [
    ...
    },
    {
      ...
      title := "HCGapL4 multi-front attack waves (R420 -- R769)"
      kind := "active"
      status := "exploratory"
      summary :=
      ...
      attackPlan := [
        ...
        "R769 next attack: prove exact image `Submodule.map j_q source_invariants = surjectivity_target`, prove source-H8, and construct the scalar-preimage certificate from EVII Matsushima/Borel--Wallach multiplicity or quotient-vanishing geometry.",
