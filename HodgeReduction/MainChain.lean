...
def config : ChainAudit.ProjectConfig := {
  ...
  researchGaps := [
    ...
    },
    {
      ...
      title := "HCGapL4 multi-front Layer-4 attack waves (R420 -- R755)"
      status := "active-open"
      summary :=
  ...
  researchChains := [
    ...
    },
    {
      ...
      title := "HCGapL4 multi-front attack waves (R420 -- R755)"
      kind := "active"
      status := "exploratory"
      summary :=
      ...
      attackPlan := [
        ...
        "R755 next attack: prove `compactDual = H8`, prove `surjectivity_source = compactDual`, and prove `trivialModulePart <= Submodule.map j_q CartanH8`; this is the structural Cartan-image version of the target-line theorem.",
