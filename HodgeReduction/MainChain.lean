  ...
  researchChains := [
    ...
    },
    {
      ...
      attackPlan := [
        ...
        "R751 next attack: do not try to prove the whole `MatsushimaV56BoundaryData` package at once.  Prove `compactDual = H8`, prove the source equality `surjectivity_source = compactDual`, and prove the automorphic rank-one target `finrank trivialModulePart = 1`; those three fields rebuild the current boundary/compact-dual frontier without a stronger premise.",
