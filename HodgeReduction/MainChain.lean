...
def config : ChainAudit.ProjectConfig := {
  ...
  researchGaps := [
    ...
    },
    {
      ...
      title := "HCGapL4 multi-front Layer-4 attack waves (R420 -- R766)"
      status := "active-open"
      summary :=
  ...
  researchChains := [
    ...
    },
    {
      ...
      attackPlan := [
        ...
        "R766 next attack: construct the scalar-preimage certificate from EVII Matsushima/Borel--Wallach multiplicity or quotient-vanishing geometry, construct a nonzero target-invariant class, and keep the genuine Matsushima boundary theorem as the separate R758 consumer target.",
